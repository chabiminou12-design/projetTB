// In Models/DeclarationStrategiqueDraft.cs
using System.ComponentModel.DataAnnotations;
using System.ComponentModel.DataAnnotations.Schema;

namespace Stat.Models
{
    [Table("declarations_stratigique_draft")]
    public class DeclarationStrategiqueDraft
    {
        [Key]
        [Column("id")]
        public int ID_Draft_Strat { get; set; } // Assuming a new primary key
